...
const FooterPromBi = () => {
  ...
  const waMessage = encodeURIComponent("Hola equipo de PromBi, me interesa implementar esta herramienta y me gustaría tener mayor informacion");
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-white/5">
          <div className="mb-4 md:mb-0 flex items-center gap-2">
            <span className="text-xl font-black tracking-tight text-white">PromBi</span>
        ...
        <div className="text-center text-xs text-gray-700 mt-8">
          &copy; {new Date().getFullYear()} PromBi AI. Todos los derechos reservados.
        </div>
      </div>

      {/* Modals */}
      <Modal isOpen={showTerms} onClose={() => setShowTerms(false)} title="Términos de Servicio de PromBi">
        <p>¡Bienvenido a PromBi, impulsado por Tres Niveles! Al utilizar nuestro servicio de orquestación de IA para Power BI, aceptas los siguientes términos de forma sencilla y transparente:</p>
        <ul className="list-disc pl-5 space-y-2 mt-2">
          <li><strong className="text-gray-200">Uso de la Plataforma:</strong> PromBi es una herramienta diseñada para interactuar con tus reportes de Power BI mediante lenguaje natural. Nos comprometemos a mantener la plataforma operativa y actualizada para garantizar la mejor experiencia.</li>
          <li><strong className="text-gray-200">Responsabilidad de Datos:</strong> Tú mantienes la propiedad total y absoluta de tus datos y modelos de Power BI. PromBi actúa únicamente como un intermediario (Copiloto) que lee e interpreta, sin alterar tu información original sin tu autorización explícita.</li>
          ...
          <li><strong className="text-gray-200">Uso Adecuado:</strong> Esperamos que utilices PromBi para potenciar tu análisis de datos de manera ética y legal. Nos reservamos el derecho de suspender cuentas que intenten vulnerar la seguridad de la plataforma.</li>
        </ul>
      </Modal>

      <Modal isOpen={showPrivacy} onClose={() => setShowPrivacy(false)} title="Política de Privacidad: Tus Datos Son Tuyos">
        <p>En PromBi (por Tres Niveles), la seguridad de tu información corporativa es nuestra máxima prioridad. Entendemos que en el análisis de datos, la confidencialidad es innegociable.</p>
        <ul className="list-disc pl-5 space-y-2 mt-2">
          <li><strong className="text-gray-200">Cero Almacenamiento Permanente:</strong> PromBi no almacena copias de tus bases de datos ni de tus reportes de Power BI en nuestros servidores de forma permanente. Procesamos tus consultas en memoria al vuelo y luego la información se descarta.</li>
          <li><strong className="text-gray-200">No Entrenamos Modelos con tu Data:</strong> Garantizamos que las preguntas que le haces a PromBi y los datos de tu empresa JAMÁS se utilizarán para entrenar modelos de Inteligencia Artificial públicos ni compartidos con terceros.</li>
